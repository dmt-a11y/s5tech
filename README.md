...
src/
  modules/
    problem01/   — sum-of-N exercise
    problem02/   — wallet balances list (fetch, filter/sort, render)
    problem03/   — token swap form (React Hook Form + Zod)
  shares/
...
Before touching a module, check [`docs/`](./docs) — write-ups of non-obvious decisions, bug fixes, and refactors live there rather than in code comments. Start with [`docs/wallet-page-code-review.md`](./docs/wallet-page-code-review.md) for the reasoning behind `problem02`'s (WalletPage) current structure.
